...
#define STRING_CONFIG_H_AUTHOR "(Antonio, config Cr10 MM for github)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Cr10 MM"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  19.3,  19.3 }
    #define DEFAULT_Ki_LIST {   1.78,  1.78 }
    #define DEFAULT_Kd_LIST { 52.6, 52.6 }
  #else
  // Cr-10 MM - Mellow Crazy TC-03 50W
  #define DEFAULT_Kp 19.3
  #define DEFAULT_Ki 1.78
  #define DEFAULT_Kd 52.6
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 249
  #define DEFAULT_bedKi 48
  #define DEFAULT_bedKd 851
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 150, 10, 85 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1500, 1250, 80, 8000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -47, -5, -0.34 }
...
#define HOMING_FEEDRATE_MM_M { (90*60), (60*60), (4*60) }
